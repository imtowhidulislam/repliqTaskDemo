        ...
        <div className="">
          {productValue.map((item) => {
            ...
            return (
              <div
                key={id}
                className={`border z-0 mb-2 flex max-w-6xl animate-moveUp items-center justify-between gap-8 rounded-md border-baseClr1 bg-nutral3 p-3 drop-shadow-md delay-[${setDelay}]`}
              >
